        ...
        <div className="container">
          ...
          <div className="col-lg-5 col-md-5 col-sm-6">
            <div className="contato-formulario">
              ...
              <hr></hr>
              <div role="form" className="wpcf7" id="wpcf7-f4-o1" lang="pt-BR" dir="ltr">
                <div className="screen-reader-response">
                  <p role="status" aria-live="polite" aria-atomic="true"></p>
                  <ul></ul>
                </div>
                <form action="/contato#wpcf7-f4-o1" method="post" className="wpcf7-form init" noValidate="novalidate" data-status="init">
                  ...
                  <Par>
                    <div className="form-container">
                      ...
                      <span className="wpcf7-form-control-wrap text-1">
                        <input type="text" name="text-1" value="" size="40" className="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-contato"
                    ...
                    <div className="form-container">
                      ...
                      <span className="wpcf7-form-control-wrap email-2">
                        <input type="email" name="email-2" value="" size="40" className="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email form-contato"
                    ...
                    <div className="form-container">
                      ...
                      <span className="wpcf7-form-control-wrap tel-3"><input type="tel" name="tel-3" value="" size="40" className="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-tel form-contato mascara-tel"
                    ...
                    <div className="form-container">
                      ...
                      <span className="wpcf7-form-control-wrap text-4"><input type="text" name="text-4" value="" size="40" className="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-contato"
                    ...
                    <div className="form-container">
                      ...
                      <span className="wpcf7-form-control-wrap textarea-5"><textarea name="textarea-5" cols="40" rows="10" maxLength="400" className="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required form-contato"
                  ...
                  <input type="submit" value="Enviar mensagem" className="wpcf7-form-control has-spinner wpcf7-submit form-contato-botao botao-verde"></input>
